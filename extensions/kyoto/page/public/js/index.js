            ...
            _c("div", { staticClass: "grid grid--row grid--middle grid--30" }, [
              _c("div", { staticClass: "col--flex-0-0" }, [
                _c("h2", [
                  _vm._v(
                    _vm._s(
                      _vm.Obj.get(_vm.$route, "meta.menu.title", "Edit page")
                    )
                  )
                ])
              ]),
          ...
          _c("div", { staticClass: "kyo-titlebar col--flex-0-0" }, [
            _c("div", { staticClass: "grid grid--row grid--middle grid--30" }, [
              _c("div", { staticClass: "col--flex-0-0" }, [
                _c("h2", [
                  _vm._v(
                    _vm._s(_vm.Obj.get(_vm.$route, "meta.menu.title", "Seiten"))
                  )
                ])
              ]),
              _vm._v(" "),
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component(_pages_KyoPageEdit__WEBPACK_IMPORTED_MODULE_2__["default"].name, _pages_KyoPageEdit__WEBPACK_IMPORTED_MODULE_2__["default"]);
